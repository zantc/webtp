<template>
  <div class="pattern">
    <div class="main">
      ...
      <h2 v-if="place.amenities" class="title">TIỆN NGHI DỊCH VỤ</h2>
      <div class="amenities">
        <div
          class="amenity-item"
          v-if="place.amenities"
          v-for="amenity in place.amenities"
          :key="amenity"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
      ...
      <div
        v-if="
          place.address || place.phoneNumber || place.email || place.website
        "
        class="content"
      >
      ...
      <div class="locations-slider">
        ...
        >
          <swiper-slide v-for="nearbyPlace in places" :key="nearbyPlace.key">
            <NuxtLink
              class="slide-content"
              :to="`/${props.category}/${nearbyPlace.slug}/`"
            >
              <img
