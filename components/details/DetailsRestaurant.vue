<template>
  <div class="pattern">
    <div class="main">
      ...
      <div class="amenities">
        <div class="amenity-item" v-for="amenity in place.amenities" :key="amenity">
      ...
      <div class="booking-area">
        <div class="booking-form-container">
          <h3 class="booking-title">ĐẶT BÀN</h3>
          <form @submit.prevent>
            ...
            <div class="form-group">
              <label for="booking-time">Thời gian đặt</label>
              <input type="datetime-local" id="booking-time" required />
            </div>
            <div class="form-group">
              <label for="notes">Ghi chú</label>
              <textarea id="notes" rows="3" placeholder="Nội dung"></textarea>
            </div>
...
.booking-area {
  ...
  align-items: center; /* Thêm để căn giữa nội dung bên trong */
  position: relative; /* Rất quan trọng: Để làm mốc cho ::before */
  z-index: 1; /* Đảm bảo form và nội dung nổi lên trên nền */
}
.booking-area::before {
  content: "";
  position: absolute;
  ...
  /* Di chuyển các thuộc tính background vào đây */
  background-image: url("/public/images/places/tables_cafe_view_booking.jpg");
  background-size: cover;
  background-position: center;
  background-attachment: fixed;
  z-index: -1;

  border-radius: 8px; /* Giữ lại bo góc */
}
...
.form-group {
  ...
  margin-bottom: 1.5rem;
  gap: 1.5rem;
  border-bottom: 1px solid #444a9b;
}
...
.btn-submit-booking {
  width: 100%;
  padding: 0.9rem;
  background-color: #5e65c5; /* Màu xanh lá cây */
  color: #fff;
  border: none;
  border-radius: 8px;
  font-size: 1.1rem;
...
.btn-submit-booking:hover {
  background-color: #444a9b; /* Màu đậm hơn khi hover */
}
